...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='/Library/WebServer/Documents/reactHello/src/client/app/index.jsx';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ 1);var _react2=_interopRequireDefault(_react);
	var _reactDom=__webpack_require__(/*! react-dom */ 38);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var 
	
	App=function(_React$Component){_inherits(App,_React$Component);function App(){_classCallCheck(this,App);return _possibleConstructorReturn(this,Object.getPrototypeOf(App).apply(this,arguments));}_createClass(App,[{key:'render',value:function render()
	{
	return _react2.default.createElement('p',{__source:{fileName:_jsxFileName,lineNumber:6}},' Hello React!');}}]);return App;}(_react2.default.Component);var 
	
	
	
	Testapp=function(_React$Component2){_inherits(Testapp,_React$Component2);
	function Testapp(props){_classCallCheck(this,Testapp);var _this2=_possibleConstructorReturn(this,Object.getPrototypeOf(Testapp).call(this,
	props));
	_this2.state={isChecked:"happy"};
	
	_this2.onChange=_this2.onChange.bind(_this2);return _this2;}_createClass(Testapp,[{key:'onChange',value:function onChange()
	...
	{
	return (
	_react2.default.createElement('div',{__source:{fileName:_jsxFileName,lineNumber:24}},
	_react2.default.createElement('h1',{__source:{fileName:_jsxFileName,lineNumber:25}},' ',this.state.isChecked),
	this.props.sometext,
	_react2.default.createElement('input',{type:'text',onFocus:this.onChange,placeholder:'Your name',__source:{fileName:_jsxFileName,lineNumber:27}})));}}]);return Testapp;}(_react2.default.Component);
	...
	Grouped=function(_React$Component3){_inherits(Grouped,_React$Component3);function Grouped(){_classCallCheck(this,Grouped);return _possibleConstructorReturn(this,Object.getPrototypeOf(Grouped).apply(this,arguments));}_createClass(Grouped,[{key:'render',value:function render()
	{
	return (
	_react2.default.createElement('div',{__source:{fileName:_jsxFileName,lineNumber:37}},
	_react2.default.createElement(App,{__source:{fileName:_jsxFileName,lineNumber:38}}),
	_react2.default.createElement(Testapp,{sometext:this.props.sometext,__source:{fileName:_jsxFileName,lineNumber:39}})));}}]);return Grouped;}(_react2.default.Component);exports.default=Grouped;
